...
public class TestBeginnerHashMap {
	...
	private void printMap(Map map) throws BMapException
	{
		System.out.println(map);
		System.out.println(begin.getMapSize(map));
	}

	private HashMap getDefaultHmap() throws BMapException
	{
	...
	private void mod1() throws BMapException
	{
		HashMap map = new HashMap();
		printMap(map);
	}
	private void mod2() throws BMapException
	{
	...
	private void mod3() throws BMapException
	{
	...
	private void mod4() throws BMapException
	{
	...
	private void mod5() throws BMapException
	{
	...
	private void mod6() throws BMapException
	{
		HashMap<String,String> map = new HashMap<String,String>();
		int n=2;
		for(int i=0;i<n;i++)
	...
	private void mod7() throws BMapException
	{
		HashMap<String,String> map = new HashMap<String,String>();
		int n=2;
		for(int i=0;i<n;i++)
	...
	private void mod8() throws BMapException
	{
		getDefaultHmap();
	...
	private void mod9() throws BMapException
	{
		getDefaultHmap();
		printMap(defaultHmap);
		int n=3;
	...
	private void mod10() throws BMapException
	{
		getDefaultHmap();
		printMap(defaultHmap);
	...
	private void mod11() throws BMapException
	{
		getDefaultHmap();
		printMap(defaultHmap);
	...
	private void mod12() throws BMapException
	{
		getDefaultHmap();
		printMap(defaultHmap);
		System.out.println("Enter key to remove");
	...
	private void mod13() throws BMapException
	{
		getDefaultHmap();
		printMap(defaultHmap);
	...
	private void mod14() throws BMapException
	{
		getDefaultHmap();
		printMap(defaultHmap);
		System.out.println("Enter key to replace");
	...
	private void mod15() throws BMapException
	{
		getDefaultHmap();
	...
	private void mod16() throws BMapException
	{
		getDefaultHmap();
		printMap(defaultHmap);
	...
	public static void main(String[] args) throws BMapException
	{
